jQuery(document).ready(function ($) {
    ...
    function random() {
        ...
        userID = jQuery(".wordlist .userID").text().trim();
        //dictation!
        var wordSound = new Audio("../wp-content/uploads/userdata" + userID + "/word/" + list[random] + ".mp3");
    ...
    jQuery(".wordlist .eachword").each(function () {
        list.push($(this).text());
    });
